...
#ifndef MYIDSHARED_SWIFT_H
#define MYIDSHARED_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MyIdShared",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP10MyIdShared18MyIdClientDelegate_")
@protocol MyIdClientDelegate
...
SWIFT_CLASS("_TtC10MyIdShared13MyIdException")
...
SWIFT_CLASS("_TtC10MyIdShared13MyIdGenerator")
